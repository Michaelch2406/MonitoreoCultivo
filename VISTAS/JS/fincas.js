...
function guardarNuevaFinca() {
    ...
    if (window.usuarioActual.rol !== 'administrador') {
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-sm">
                                    <tr><td><strong>Dirección:</strong></td><td>${finca.fin_direccion}</td></tr>
                                    <tr><td><strong>Municipio:</strong></td><td>${finca.fin_municipio}</td></tr>
                                    <tr><td><strong>Departamento:</strong></td><td>${finca.fin_departamento}</td></tr>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <h6 class="text-primary"><i class="fas fa-cloud-sun me-2"></i>Información Ambiental</h6>
                                <table class="table table-sm">
                                    <tr><td><strong>Clima:</strong></td><td>${finca.fin_tipo_clima || 'No especificado'}</td></tr>
                                    <tr><td><strong>Acceso a Agua:</strong></td><td>${finca.fin_acceso_agua || 'No especificado'}</td></tr>
                                </table>
                            </div>
                            <div class="col-md-6">
                                <h6 class="text-primary"><i class="fas fa-building me-2"></i>Información Legal</h6>
                                <table class="table table-sm">
                                    <tr><td><strong>Estado Legal:</strong></td><td>${finca.fin_estado_legal || 'No especificado'}</td></tr>
                                    <tr><td><strong>Propietario:</strong></td><td>${finca.usu_nombre} ${finca.usu_apellido}</td></tr>
                                </table>
                            </div>
                        </div>
                        
                        ${finca.fin_infraestructura ? `
                        <div class="row mt-3">
                            <div class="col-12">
                                <h6 class="text-primary"><i class="fas fa-tools me-2"></i>Infraestructura</h6>
                                <p class="border p-3 rounded bg-light">${finca.fin_infraestructura}</p>
                            </div>
                        </div>
                        ` : ''}
...
function validarFormularioFinca() {
    ...
    const camposRequeridos = ['nombre', 'direccion', 'municipio', 'departamento', 'area_total'];
